...
```javascript
{
  ...
  mazmot: { source: "ai-builder" }, // 仅 AI 应用生成器生成的应用有值：来源标记；
                             // 主系统应用列表据此隐藏全部生成应用（记录仅供
                             // ai-app-builder 持久化句柄与应用管理）
...
| AI 应用生成器官方应用（对话生成 ofa.js 应用 → 写入 mazmot-apps VFS → 预览） | [official-apps/ai-app-builder/pages/home.html](official-apps/ai-app-builder/pages/home.html)（核心库 [lib/builder.js](official-apps/ai-app-builder/lib/builder.js)，测试 [test/builder.sb.html](official-apps/ai-app-builder/test/builder.sb.html)） |
